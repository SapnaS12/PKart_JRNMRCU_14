...
import com.pkart.service.*;

public class AdminController {

	private static IProductService productService;  //Creating Object for Product Service
	private static ICustomerService customerService;  //Creating Object for Customer Service
	...
	public void operations() {
		...
		while (status) {
			...
			case 1:
				...
				String mfDate = scanner.nextLine();
