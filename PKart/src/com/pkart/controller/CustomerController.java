...
public class CustomerController {
	...
	//Creating Object for Customer Service
	...
	public void operations() {
		...
		while(status)
		{
			...
			{
				case 1:
					System.out.println("Enter Id, Name, Email, PhoneNo, Address: ");
				...
				case 2:
					...
					Customer customer1 = customerService.viewCustomer(id1);  //Calling method from customer
